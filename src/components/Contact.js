...
const Contact = () => {
    return <section className="section bg-primary" id="contact">
        <div className="container mx-auto">
            ...
            <div className="flex flex-col items-center text-center">
                ...
                elit. Nulla corrupti quod vitae delectus cumque 
                vero atque possimus ea doloribus ut.
                </p>
            </div>
                ...
                <form className="space-y-8 w-full max-w-[780px]">
                    ...
                    <textarea 
                        ...
                        <button className="btn btn-lg bg-accent">Send message</button>
                </form>
            </div>
        </div>
    </section>
