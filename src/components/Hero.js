...
// import man image
import WomaImg from '../assets/img/banner-woman2.webp'

const Hero = () => {
  return (
    <section id="home" className="lg:h-[85vh] flex items-center
     bg-primary lg:bg-center lg:bg-no-repeat 
     py-32 lg:py-0 overflow-hidden">
      <div className="container mx-auto h-full">
        <div className="flex items-center h-full pt-8">
            ...
            Lorem ipsum dolor sit amet consectetklklhr, 
            adipisicing elit. Culpa odio suscipit,
            </p>
            <button className="btn btn-md bg-accent hover:bg-accent-hover md:btn-lg transition-all">Contact Us</button>
            </div>
            {/* right side */}
